...
* Хагрузите Nodejs (рекомендуется версия v8.11):  https://nodejs.org/en
...
* В версии с Nodejs при старте для http исползуется порт 80, его можно поменять в закладке CONFIG в интерфейсе кошелька (нажмите кнопку HTTP ACESS), вместе с ним можно установить пароль на доступ к интерфейсу. Рекомендуется это делать если вы используете терминальный Линукс с публичным адресом.
