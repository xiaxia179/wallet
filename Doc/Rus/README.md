...
Примечание: в данном репозитарии файлы setup.exe и updater.exe всегда содержат одинаковые версии пограммы.
...
* ВНИМАНИЕ: установите пароль для ограничения доступа по http (нажмите кнопку HTTP ACCESS на вашем кошельке)
