...
* ВНИМАНИЕ 1: Установите пароль для ограничения доступа по http (нажмите кнопку HTTP ACCESS на вашем кошельке)
* ВНИМАНИЕ 2: Кнопка "Set password" - это еще один пароль предназначенный только для хеширования приватного ключа при записи его в настроечный файл.
